...
<body class="container">
    ...
    <div class="jumbotron">
        ...
        <button class="btn btn-success" id="btnRegister" data-toggle="modal" data-target="#register">S'inscrire</button>
        <button class="btn btn-success" id="btnLogin" data-toggle="modal" data-target="#login">Se connecter</button>
    </div>
